  ...
  render(){
    ...
    <Tag color="lime">{this.state.count}</Tag> */}
      <Col>
        ...
        <Row><Link to="/owner"><Button>Go to owner</Button></Link></Row>
        <Row><Link to="/pet"><Button>Go to pet</Button></Link></Row>
        <Row><Link to="/service"><Button>Go to service</Button></Link></Row>
      </Col>
    </div>)
  }
}
